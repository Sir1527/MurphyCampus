...
public class MyFragmentOrderPending extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        initData();
        initRecyclerView();
        RecyclerView viewById = view.findViewById(R.id.recyclerViewOrderPending);
    ...
    private void initData() {
        ...
        List<Errand> all = errandDao.getStatusByPendingByPublisherId("待接单",uid);
        orderList = (ArrayList<Errand>) all;
    }

    private void initRecyclerView() {
        homeRecyclerView = (RecyclerView)view.findViewById(R.id.recyclerViewOrderPending);
