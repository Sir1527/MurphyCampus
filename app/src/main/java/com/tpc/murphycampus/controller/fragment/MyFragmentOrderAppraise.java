...
public class MyFragmentOrderAppraise extends Fragment {
    private View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_order_appraise, container, false);
        initData();
        initRecyclerView();
        RecyclerView viewById = view.findViewById(R.id.recyclerViewOrderAppraise);
    ...
    private void initData() {
        ...
        List<Errand> all = errandDao.getStatusByPendingByPublisherId("待评价",uid);
        orderList = (ArrayList<Errand>) all;
    }

    private void initRecyclerView() {
        homeRecyclerView = (RecyclerView)view.findViewById(R.id.recyclerViewOrderAppraise);
