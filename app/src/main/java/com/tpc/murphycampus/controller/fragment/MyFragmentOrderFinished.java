...
public class MyFragmentOrderFinished extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_order_finished, container, false);
        initData();
        initRecyclerView();
        RecyclerView viewById = view.findViewById(R.id.recyclerViewOrderFinished);
    ...
    private void initData() {
        ...
        List<Errand> all = errandDao.getStatusByPendingByPublisherId("已完成",uid);
        orderList = (ArrayList<Errand>) all;
    }

    private void initRecyclerView() {
        homeRecyclerView = (RecyclerView)view.findViewById(R.id.recyclerViewOrderFinished);
