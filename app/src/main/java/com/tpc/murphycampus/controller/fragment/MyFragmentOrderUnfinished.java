...
public class MyFragmentOrderUnfinished extends Fragment {
    private View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_order_unfinished, container, false);
        initData();
        initRecyclerView();
        RecyclerView viewById = view.findViewById(R.id.recyclerViewOrderUnfinished);
    ...
    private void initData() {
        ...
        List<Errand> all = errandDao.getStatusByPendingByPublisherId("待完成",uid);
        orderList = (ArrayList<Errand>) all;
    }

    private void initRecyclerView() {
        homeRecyclerView = (RecyclerView)view.findViewById(R.id.recyclerViewOrderUnfinished);
