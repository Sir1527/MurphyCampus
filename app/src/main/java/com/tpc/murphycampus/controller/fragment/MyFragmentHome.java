...
public class MyFragmentHome extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView viewById = view.findViewById(R.id.recyclerView);
    ...
    private void initData() {
        ...
        List<Errand> all = errandDao.getStatusByPending("待接单");
        orderList = (ArrayList<Errand>) all;
    }

    private void initRecyclerView() {
        homeRecyclerView = (RecyclerView)view.findViewById(R.id.recyclerView);
        ...
        homeRecycleAdapter.setOnItemClickListener(new HomeRecycleAdapter.OnItemClickListener() {
            ...
            public void OnItemClick(View view, Errand data) {
                ...
                Toast.makeText(getContext(),"接单成功！",Toast.LENGTH_LONG).show();
            }
        });
    }
}